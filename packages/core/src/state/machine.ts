  ...
  states: {
    ...
    cloud: {
      ...
      states: {
        ...
        creating: {
          onEnter: ["createCloudShape", "setSnapshot"],
          on: {
            TOGGLED_MODIFIER: "transformSelectedShapes",
            MOVED_POINTER: "transformSelectedShapes",
            PANNED: "transformSelectedShapes",
            ...
            STOPPED_POINTING: {
              do: ["addToHistory", "populateCloudShape"],
              to: "select",
            },
          },
        },
    ...
    scrollbox: {
      ...
      states: {
        ...
        creating: {
          onEnter: ["createScrollBoxShape", "setSnapshot"],
          on: {
            TOGGLED_MODIFIER: "transformSelectedShapes",
            MOVED_POINTER: "transformSelectedShapes",
            PANNED: "transformSelectedShapes",
